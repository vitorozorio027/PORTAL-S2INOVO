                ...
                <v-row>
                    <v-col cols="2">
                        <div>
                            ...
                            <input type="text" v-model="modalidadeDigitada" style="font-size: 10px;" class="w-100 pa-2 border mt-1 rounded" readonly>
                        </div>
                    ...
                    <v-col cols="1">
                        <div >
                            ...
                            <input type="text" v-model="ordemDigitada" style="font-size: 10px;" class="w-100 pa-2 border mt-1 rounded" readonly>
                        </div>
                    ...
                    <v-col cols="3">
                        <div>
                            ...
                            <input type="text" v-model="descInsp" style="font-size: 10px;" class="w-100 pa-2 border mt-1 rounded" readonly>
                        </div>
                    ...
                    <v-col cols="2">
                        <div>
                            ...
                            <input type="date" v-model="dataInicio" style="font-size: 10px;" class="w-100 pa-2 border mt-1 rounded readonly">
                        </div>
                    ...
                    <v-col cols="2">
                        <div>
                            ...
                            <input type="date" v-model="dataFim" style="font-size: 10px;" class="w-100 pa-2 border mt-1 rounded readonly">
                        </div>
                    ...
                    <v-col cols="2">
                        <div>
                            ...
                            <input type="text" v-model="statusDigitado" style="font-size: 10px;" class="w-100 pa-2 border mt-1 rounded" readonly>
                        </div>
...
const modalidadeDigitada = ref(localStorage.modalidadeDigitada);
const ordemDigitada = ref(localStorage.ordemDigitada);
const descInsp = ref(localStorage.descInsp);
const dataInicio = ref(localStorage.dataInicio);
const dataFim = ref(localStorage.dataFim);
const statusDigitado = ref(localStorage.statusDigitado);
